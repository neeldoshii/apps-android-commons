...
public class NearbyParentFragment extends CommonsDaggerSupportFragment
    ...
    public void onDestroyView() {
        ...
        binding = null; // Clear the binding when the fragment is destroyed to avoid memory leaks.
    }
    ...
    public void centerMapToPosition(fr.free.nrw.commons.location.LatLng searchLatLng) {
        if (null != searchLatLng && !(
            binding.map.getMapCenter().getLatitude() == searchLatLng.getLatitude()
                && binding.map.getMapCenter().getLongitude() == searchLatLng.getLongitude())) {
            ...
            public void onReceive(final Context context, final Intent intent) {
                if (getActivity() != null) {
                    if (NetworkUtils.isInternetConnectionEstablished(getActivity())) {
                        ...
                        if (snackbar == null) {
                            snackbar = Snackbar.make(requireView(), R.string.no_internet,
    ...
    private void showFABs() {
        NearbyFABUtils.addAnchorToBigFABs(binding.fabPlus, bottomSheetDetails.getId());
    ...
    public void onConfigurationChanged(@NonNull final Configuration newConfig) {
        ...
        ViewGroup.LayoutParams rlBottomSheetLayoutParams = binding.bottomSheetNearby.bottomSheet
            .getLayoutParams();
